export default function PictorialKeyLarvaePage() {
    return (
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-900/20 rounded-lg p-6 mb-8">
                            ...
                            <p className="text-slate-800 dark:text-slate-200 mb-4">
                                Primary morphological characteristics used in larval identification of cerambycid
                                beetles
                            </p>
                            <img
                                src="https://my-cdn-worker.longicorea.workers.dev/images/pictorial_key/larva.webp"
                                alt="Key Features for Larval Identification"
