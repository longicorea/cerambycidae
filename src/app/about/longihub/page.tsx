                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 mb-8">
                            <h2 className="text-xl font-semibold text-blue-900 dark:text-blue-300 mb-3">Project
                                Overview</h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-8">
                            <div>
                                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Scientific
                                    Approach</h2>
                        ...
                        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-6 mb-6">
                            <h3 className="text-lg font-semibold text-green-900 dark:text-green-300 mb-2">Contact &
                                Feedback</h3>
