        ...
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-4xl mx-auto px-4 py-8">
                <div className="bg-white rounded-lg shadow-sm p-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-6">Seunghyun Lee (이승현)</h1>
                    ...
                    <div className="prose prose-lg max-w-none">
                            ...
                            <div className="md:w-1/3">
                                <div className="bg-gray-100 rounded-lg p-6">
                                    ...
                                    <div className="space-y-2 text-sm text-gray-600">
                                        ...
                                        <p><strong>Website:</strong> <a href="https://chiyark.wixsite.com/mysite" className="text-blue-600 hover:underline">Personal Site</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-blue-50 rounded-lg p-6 mb-8">
                            <h3 className="text-lg font-semibold text-blue-900 mb-2">Education & Background</h3>
                            <div className="text-blue-800 space-y-2">
                                <p><strong>Current:</strong> Graduate Student in Entomology, Seoul National University</p>
                                <p><strong>Research Focus:</strong> Integrative taxonomy of Cerambycidae using morphological and molecular data</p>
                                <p><strong>Specialization:</strong> Larval and pupal morphology, DNA barcoding, digital documentation</p>
                            </div>
                        </div>
                        
                        <div className="bg-green-50 rounded-lg p-6 mb-8">
                            <h3 className="text-lg font-semibold text-green-900 mb-2">LongiHUB Project</h3>
                            <p className="text-green-800">
                                As the founder and principal investigator of LongiHUB, I lead the collection, identification, 
                                and molecular verification of longhorn beetle specimens. This project represents years of 
                        ...
                        <div className="grid md:grid-cols-1 gap-6">
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 mb-3">Research Contributions</h3>
                                <ul className="space-y-2 text-gray-700">
                                    <li>• Development of integrated morphological-molecular approach for larval identification</li>
                                    <li>• Creation of comprehensive image database with high-resolution photography</li>
                                    <li>• DNA barcoding of Korean longhorn beetle species for accurate identification</li>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6 mt-8">
                            ...
                            <p className="text-gray-700">
                                ...
                                If you are interested in longhorn beetle research, larval identification, or contributing 
