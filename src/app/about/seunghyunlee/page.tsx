                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 mb-8">
                            <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-300 mb-2">Education & Background</h3>
                        ...
                        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-6 mb-8">
                            <h3 className="text-lg font-semibold text-green-900 dark:text-green-300 mb-2">LongiHUB Project</h3>
                        ...
                        <div className="grid md:grid-cols-1 gap-6">
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Research Contributions</h3>
