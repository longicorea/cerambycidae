    ...
    return (
        <div className={`relative ${className}`}>
            <input
                ...
                className="shadow-[0px_0px_20px_2px_#dfe5ed] dark:shadow-none rounded-full h-14 w-full min-w-0 text-[26px] font-light px-6 text-gray-600 placeholder:font-thin  focus:outline-none focus:border-inherit focus:ring-0 dark:bg-slate-800 placeholder:text-2xl placeholder:text-white dark:text-white"
            />
